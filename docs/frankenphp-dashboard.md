...
The FrankenPHP tab appears when Ember detects a FrankenPHP server. It provides per-thread introspection, worker management, and memory tracking. Ember is [recommended by FrankenPHP](https://frankenphp.dev/).
