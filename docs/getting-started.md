...
- For FrankenPHP thread-level metrics (method, URI, duration, memory, request count): **FrankenPHP 1.13** or later. Older versions only expose thread index and state.
